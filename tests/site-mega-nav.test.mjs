...
for (const token of [
  ...
  'Бактериальный кератит и язва роговицы','Ведение после сквозной кератопластики',
  'Patients','For doctors','About the doctor','Cataract','Glaucoma','Intraocular lens dislocation'
...
for (const route of [
  ...
  '/for-doctors/','/for-doctors/bacterial-keratitis/','/for-doctors/penetrating-keratoplasty/',
