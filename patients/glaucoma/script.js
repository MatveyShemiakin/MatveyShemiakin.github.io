...
(() => {
  ...
  if(sources&&!document.querySelector('.ecosystem-nav')){
    ...
    const iol=isEnglish?'/en/patients/iol-dislocation/':'/patients/iol-dislocation/';
    nav.innerHTML=isEnglish
      ?'<strong>Patient information</strong><div class="ecosystem-nav-links"><a href="'+hub+'">All patient materials</a><a href="'+cataract+'">Cataract</a><a href="'+iol+'">IOL dislocation</a></div>'
      :'<strong>Материалы для пациентов</strong><div class="ecosystem-nav-links"><a href="'+hub+'">Все материалы</a><a href="'+cataract+'">Катаракта</a><a href="'+iol+'">Смещение ИОЛ</a></div>';
