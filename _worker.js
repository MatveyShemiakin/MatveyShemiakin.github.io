...
import { handleFeedbackRequest } from './workers/ophthasearch-v2/feedback-handler.js';
...
export async function handleRequest(request, env, ctx, deps = {}) {
  ...
  if (url.pathname === '/v2/feedback') return handleFeedbackRequest(request, env, ctx, deps);
