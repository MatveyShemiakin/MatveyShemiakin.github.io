  ...
  return [
    {
      ...
      content: [
        ...
        'Pilot, feasibility and uncontrolled studies provide preliminary signals, not established efficacy or routine prescribing recommendations. When direct support is limited to such studies, state this in the bottom line, use low confidence and leave management empty. Preserve non-significant results and conflicts; do not turn trends into benefits. Distinguish anterior/posterior and arteritic/non-arteritic neuropathy and chronic/acute disease. Never generalize one subgroup to all patients.',
